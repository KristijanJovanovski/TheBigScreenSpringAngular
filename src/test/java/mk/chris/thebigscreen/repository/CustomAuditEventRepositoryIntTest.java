...
import mk.chris.thebigscreen.TheBigScreenApp;
import mk.chris.thebigscreen.config.Constants;
import mk.chris.thebigscreen.config.audit.AuditEventConverter;
import mk.chris.thebigscreen.domain.PersistentAuditEvent;
...
import static mk.chris.thebigscreen.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
@SpringBootTest(classes = TheBigScreenApp.class)
@Transactional
