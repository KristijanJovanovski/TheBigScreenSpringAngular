...
import { PeopleDialogComponent } from '../../../../../../main/webapp/app/entities/people/people-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('People Management Dialog Component', () => {
        let comp: PeopleDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(PeopleDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'peopleListModification', content: 'OK'});
