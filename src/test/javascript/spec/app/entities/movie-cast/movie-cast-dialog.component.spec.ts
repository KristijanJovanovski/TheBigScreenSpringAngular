...
import { MovieCastDialogComponent } from '../../../../../../main/webapp/app/entities/movie-cast/movie-cast-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('MovieCast Management Dialog Component', () => {
        let comp: MovieCastDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(MovieCastDialogComponent, '')
            .compileComponents();
        }));
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new MovieCast(123);
                        spyOn(service, 'update').and.returnValue(Observable.of(new HttpResponse({body: entity})));
                        comp.movieCast = entity;
                        // WHEN
                        comp.save();
                        tick(); // simulate async
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'movieCastListModification', content: 'OK'});
